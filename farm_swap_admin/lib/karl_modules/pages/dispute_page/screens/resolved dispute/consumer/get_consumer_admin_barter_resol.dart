...
class GetConsumerAdminBarterResol extends StatefulWidget {
  const GetConsumerAdminBarterResol({super.key});

  @override
  State<GetConsumerAdminBarterResol> createState() => _GetConsumerAdminBarterResolState();
}

class _GetConsumerAdminBarterResolState extends State<GetConsumerAdminBarterResol> {
  @override
