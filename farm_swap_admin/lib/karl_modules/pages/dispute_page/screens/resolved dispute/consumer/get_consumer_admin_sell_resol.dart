...
class GetConsumerAdminSellResol extends StatefulWidget {
  const GetConsumerAdminSellResol({super.key});

  @override
  State<GetConsumerAdminSellResol> createState() => _GetConsumerAdminSellResolState();
}

class _GetConsumerAdminSellResolState extends State<GetConsumerAdminSellResol> {
  @override
