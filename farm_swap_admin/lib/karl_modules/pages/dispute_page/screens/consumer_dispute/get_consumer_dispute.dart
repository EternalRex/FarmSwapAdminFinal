...
import 'package:farm_swap_admin/karl_modules/pages/dispute_page/screens/consumer_dispute/consumer_dispute_details.dart';
import 'package:flutter/material.dart';
import 'package:font_awesome_flutter/font_awesome_flutter.dart';
import 'package:intl/intl.dart';

class GetConsumerBarterDispute extends StatefulWidget {
  const GetConsumerBarterDispute({super.key});

  @override
  State<GetConsumerBarterDispute> createState() => _GetConsumerBarterDisputeState();
}

class _GetConsumerBarterDisputeState extends State<GetConsumerBarterDispute> {
  ...
  Widget _buildCCompleteBarterListItems(DocumentSnapshot document) {
    ...
    String consumerDisputedStatus = barter['farmerDisputeStatus'];
    bool isResolved = barter['isResolved'];
    Timestamp disputeFiledDate = barter['disputeDateFile'];
    String consumerDisputeText = barter['farmerDisputeText'];
    String consumerDisputeUrl = barter['farmerDisputeUrl'];
    /*Listing details */
    ...
    /*Transaction details*/
    double deductedFSwapCoins = (barter['deductedFarmerCoins'] as num).toDouble();
    double deductedConsumerCoins = (barter['deductedConsumerCoins'] as num).toDouble();
              ...
              IconButton(
                onPressed: () {
                  ...
                  Navigator.of(context).push(
                    MaterialPageRoute(
                      builder: (context) {
                        return ConsumerDisputeBarterDetails(
                            ...
                            itemValue: itemValue,
                            itemUrl: itemUrl,
                            consumerDisputedStatus: consumerDisputedStatus,
