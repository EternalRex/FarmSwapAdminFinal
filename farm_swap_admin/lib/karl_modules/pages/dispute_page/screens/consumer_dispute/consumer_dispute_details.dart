...
import 'package:farm_swap_admin/karl_modules/pages/dispute_page/database/consumer_barter_save_resolution.dart';
...
class _ConsumerDisputeBarterDetailsState extends State<ConsumerDisputeBarterDetails> {
  ...
  SaveConsumerBarterDisputeResolution saveCBResol = SaveConsumerBarterDisputeResolution();
...
/*DIri ang e enter nimo ang message para kang offender*/
                                  Padding(
                                            ...
                                            children: [
                                              ...
                                              Theme(
                                                ...
                                                child: SizedBox(
                                                  width: 330,
                                                  height: 70,
                                                  /*Actual text field na inputan sa imong resoultion and message button*/
                                                  child: TextField(
...
/*DROP DOWN SA WHAT KIND OF HATOL ANG E HATAG*/
                                              Padding(
                                              ...
                                              Padding(
                                                ...
                                                child: ElevatedButton(
                                                  /*Submit onpressed submiting the details */
                                                  onPressed: () {
                                                    /*Updating the is resolved field of dispute to true */
                                                    saveCBResol.updateConsumerDisputeResolved(
                                                        widget.listingId, widget.consumerId);
                                                    /*Save the resolution to the database */
                                                    saveCBResol.consBarterResolution(
                                                      widget.listingUrl,
                                                      widget.itemUrl,
