...
import 'package:farm_swap_admin/karl_modules/pages/dispute_page/screens/farmer_dispute/farmer_dispute_sale_details.dart';
import 'package:flutter/material.dart';
import 'package:font_awesome_flutter/font_awesome_flutter.dart';
import 'package:intl/intl.dart';

class GetFarmerSaleDispute extends StatefulWidget {
  const GetFarmerSaleDispute({super.key});

  @override
  State<GetFarmerSaleDispute> createState() => _GetFarmerSaleDisputeState();
}

class _GetFarmerSaleDisputeState extends State<GetFarmerSaleDispute> {
              ...
              IconButton(
                onPressed: () {
                  Navigator.of(context).push(
                    MaterialPageRoute(
                      builder: (context) => FarmerDisputeSellDetails(
