...
import 'package:farm_swap_admin/karl_modules/pages/chat_page/screens/farmer_chat/farmer_actual_chat.dart';
...
class _FarmerChatScreenState extends State<FarmerChatScreen> {
  ...
  Widget _buildUserListItems(DocumentSnapshot document) {
    ...
    String farmerId = users['userId'];
    String farmerName = users["firstname"];
    String farmerLname = users["lastname"];
    String farmerEmail = users["email"];
    String farmerUname = users["userName"];
    String farmerProfileUrl = users['profilePhoto'];
        ...
        address to the next screen which is the AsminActual Screen */
          onTap: () {
            Navigator.of(context).push(
              MaterialPageRoute(
                builder: (context) {
                  return FarmerActualChat(
                    farmerId: farmerId,
                    farmerLname: farmerLname,
                    farmerName: farmerName,
                    farmerUname: farmerUname,
                    profilePhoto: farmerProfileUrl,
                    isOnline: isOnline,
