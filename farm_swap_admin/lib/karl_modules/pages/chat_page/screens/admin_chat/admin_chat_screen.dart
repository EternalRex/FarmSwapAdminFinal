...
import 'package:farm_swap_admin/karl_modules/pages/chat_page/screens/admin_chat/admin_actual_chat.dart';
...
/*Only the specific account searched will display*/
    if (searchValue.isNotEmpty) {
      ...
      if (users["First Name"].toString().toLowerCase() == searchValueLowerCase ||
          users["Last Name"].toString().toLowerCase() == searchValueLowerCase ||
          users["Email Address"].toString().toLowerCase() == searchValueLowerCase) {
        return ListTile(
          title: Container(
