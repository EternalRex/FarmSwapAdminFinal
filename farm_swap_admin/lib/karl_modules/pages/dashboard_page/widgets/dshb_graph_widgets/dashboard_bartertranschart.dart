...
class BarterTransChart extends StatefulWidget {
  const BarterTransChart({super.key});

  @override
  State<BarterTransChart> createState() => _BarterTransChartState();
}

class _BarterTransChartState extends State<BarterTransChart> {
  ...
  Future<void> fetchData() async {
    final CollectionReference transactions =
        FirebaseFirestore.instance.collection('sample_BarterTransactions');
