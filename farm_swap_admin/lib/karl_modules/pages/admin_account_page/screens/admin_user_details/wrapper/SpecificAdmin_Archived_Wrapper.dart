...
class AdminSpecificArchivedWrapper extends StatefulWidget {
  AdminSpecificArchivedWrapper({
    super.key,
  ...
  @override
  State<AdminSpecificArchivedWrapper> createState() =>
      _AdminSpecificArchivedWrapperState();
}

class _AdminSpecificArchivedWrapperState
    extends State<AdminSpecificArchivedWrapper> {
              ...
              child: Scaffold(
                appBar: AppBar(
                  ...
                  title: const DashBoardTitleText(
                    myText: "Admin User Archived Account",
