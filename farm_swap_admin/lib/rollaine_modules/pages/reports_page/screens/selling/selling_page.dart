...
import 'package:farm_swap_admin/rollaine_modules/pages/reports_page/screens/selling/selltrans_details_wrapper.dart';
...
class _Selling extends State<Selling> {
          ...
          return Padding(
            ...
            child: ListView(
              ...
              children: snapshot.data!.docs
                  .map<Widget>((document) => _buildSellTransListItems(document))
                  .toList(),
            ),
          );
        } else {
  ...
  Widget _buildSellTransListItems(DocumentSnapshot document) {
    ...
    if (searchValue.isNotEmpty) {
      ...
      if (sell['listingName'].toString().toLowerCase() ==
              searchValueLowerCase ||
          sell['farmerBarangay'].toString().toLowerCase() ==
              searchValueLowerCase ||
          sell['farmerMunicipality'].toString().toLowerCase() ==
              searchValueLowerCase) {
                            ...
                            IconButton(
                              onPressed: () {
                                Navigator.of(context).push(
                                  MaterialPageRoute(
                                    builder: (context) => SellTransDetails(
                                        addamount: addedAmount,
                                        cbarangay: consBaranay,
                                        clname: consLName,
                                        cmunicipal: consMunicipality,
                                        cname: consName,
                                        curl: consProfileUrl,
                                        cuname: consUname,
