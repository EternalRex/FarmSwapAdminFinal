...
import 'package:farm_swap_admin/constants/userid/farmer_individual_details.dart';
import 'package:farm_swap_admin/rollaine_modules/pages/listings_page/models/barter_listing_model.dart';
...
/*Instance of the class that directly pulls out the individual data the current farmer user */
  ...
  Future<void> saveBarteringListing(
    ...
    final saveDate = BarterProductListingModel(
