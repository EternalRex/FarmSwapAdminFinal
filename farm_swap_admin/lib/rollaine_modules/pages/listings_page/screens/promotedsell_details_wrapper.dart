...
class SellPromotedDetails extends StatefulWidget {
  const SellPromotedDetails({
    super.key,
    required this.url,
    required this.name,
    required this.disc,
  ...
  @override
  State<SellPromotedDetails> createState() => _SellPromotedDetailsState();
}

class _SellPromotedDetailsState extends State<SellPromotedDetails> {
  @override
              ...
              child: Scaffold(
                appBar: AppBar(
                  ...
                  title: const TitleText(
                    myText: 'Promoted Selling Products',
