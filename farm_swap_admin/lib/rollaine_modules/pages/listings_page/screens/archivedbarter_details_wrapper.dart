...
class ArchivedBarterDetails extends StatefulWidget {
  const ArchivedBarterDetails({
    super.key,
    required this.url,
    required this.name,
    required this.disc,
  ...
  @override
  State<ArchivedBarterDetails> createState() => _ArchivedBarterDetailsState();
}
              ...
              child: Scaffold(
                appBar: AppBar(
                  ...
                  title: const TitleText(
                    myText: 'Archived Barter Details',
            ...
            TextButton(
              onPressed: () {
                ...
                adminLogs.createAdminLogs(
                    email, userId, "Reactivate_Barter_Listing", DateTime.now());
