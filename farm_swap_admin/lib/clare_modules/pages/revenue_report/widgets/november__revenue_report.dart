...
class NovemberRevenueTabBarView extends StatefulWidget {
  const NovemberRevenueTabBarView({super.key});

  @override
  State<NovemberRevenueTabBarView> createState() =>
      _NovemberRevenueTabBarViewState();
}

TextEditingController searchController = TextEditingController();
String searchValue = "";

class _NovemberRevenueTabBarViewState extends State<NovemberRevenueTabBarView> {
                        ...
                        Expanded(
                          ...
                          child: StreamBuilder<QuerySnapshot>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              // Displaying the sum of swapcoins for the month of november where status is COMPLETED
                              return Text(
    ...
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snapshot) {
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          // Filter logs for the selected year and november
          final selectedYearLogs = logs.where((document) {
            ...
            return (selectedYear == 'Overall' ||
                ...
                (dateTime as DateTime).month == DateTime.november;
          }).toList();

          // This will display if there are no logs for this month
          if (selectedYearLogs.isEmpty) {
            return const Center(
              child: Text('No revenue reports available for November!'),
            );
          }
