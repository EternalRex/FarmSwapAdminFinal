...
class JuneRevenueTabBarView extends StatefulWidget {
  const JuneRevenueTabBarView({super.key});

  @override
  State<JuneRevenueTabBarView> createState() => _JuneRevenueTabBarViewState();
}

TextEditingController searchController = TextEditingController();
String searchValue = "";

class _JuneRevenueTabBarViewState extends State<JuneRevenueTabBarView> {
                        ...
                        Expanded(
                          ...
                          child: StreamBuilder<QuerySnapshot>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              // Filter documents for june
                              List<DocumentSnapshot> juneDocuments =
                              ...
                              double sum = juneDocuments.fold(0.0,
                              ...
                              // Displaying the sum of swapcoins for the month of june where status is COMPLETED
                              return Text(
    ...
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snapshot) {
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          // Filter logs for the selected year and June
          final selectedYearLogs = logs.where((document) {
            ...
            return (selectedYear == 'Overall' ||
                ...
                (dateTime as DateTime).month == DateTime.june;
          }).toList();

          // This will display if there are no logs for this month
          if (selectedYearLogs.isEmpty) {
            return const Center(
              child: Text('No revenue reports available for June!'),
            );
          }
