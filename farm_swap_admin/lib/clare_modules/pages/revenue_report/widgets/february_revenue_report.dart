...
class FebruaryRevenueTabBarView extends StatefulWidget {
  const FebruaryRevenueTabBarView({super.key});

  @override
  State<FebruaryRevenueTabBarView> createState() =>
      _FebruaryRevenueTabBarViewState();
}

TextEditingController searchController = TextEditingController();
String searchValue = "";

class _FebruaryRevenueTabBarViewState extends State<FebruaryRevenueTabBarView> {
                        ...
                        Expanded(
                          ...
                          child: StreamBuilder<QuerySnapshot>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              // Displaying the sum of swapcoins for the month of february where status is COMPLETED
                              return Text(
    ...
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snapshot) {
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          // Filter logs for the selected year and February
          final selectedYearLogs = logs.where((document) {
            ...
            return (selectedYear == 'Overall' ||
                ...
                (dateTime as DateTime).month == DateTime.february;
          }).toList();

          // This will display if there are no logs for this month
          if (selectedYearLogs.isEmpty) {
            return const Center(
              child: Text('No revenue reports available for February!'),
            );
          }
