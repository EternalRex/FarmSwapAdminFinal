...
class MarchRevenueTabBarView extends StatefulWidget {
  const MarchRevenueTabBarView({super.key});

  @override
  State<MarchRevenueTabBarView> createState() => _MarchRevenueTabBarViewState();
}

TextEditingController searchController = TextEditingController();
String searchValue = "";

class _MarchRevenueTabBarViewState extends State<MarchRevenueTabBarView> {
                        ...
                        Expanded(
                          ...
                          child: StreamBuilder<QuerySnapshot>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              // Displaying the sum of swapcoins for the month of march where status is COMPLETED
                              return Text(
    ...
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snapshot) {
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          // Filter logs for the selected year and March
          final selectedYearLogs = logs.where((document) {
            ...
            return (selectedYear == 'Overall' ||
                ...
                (dateTime as DateTime).month == DateTime.march;
          }).toList();

          // This will display if there are no logs for this month
          if (selectedYearLogs.isEmpty) {
            return const Center(
              child: Text('No revenue reports available for March!'),
            );
          }
