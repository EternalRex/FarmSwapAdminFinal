...
class JanuaryRevenueTabBarView extends StatefulWidget {
  const JanuaryRevenueTabBarView({super.key});

  @override
  State<JanuaryRevenueTabBarView> createState() => _JanuaryRevenueState();
}

TextEditingController searchController = TextEditingController();
String searchValue = "";

class _JanuaryRevenueState extends State<JanuaryRevenueTabBarView> {
          ...
          children: [
            ...
            Container(
              ...
              child: SingleChildScrollView(
                child: SizedBox(
                  height: 500,
                  child: _buildJanuaryRevenueList(selectedYear),
  ...
  Widget _buildJanuaryRevenueList(String selectedYear) {
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snapshot) {
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          // Filter logs for the selected year and January
          final selectedYearLogs = logs.where((document) {
            ...
            return (selectedYear == 'Overall' ||
                ...
                (dateTime as DateTime).month == DateTime.january;
          }).toList();

          // This will display if there are no logs for this month
          if (selectedYearLogs.isEmpty) {
            return const Center(
              child: Text('No revenue reports available for January!'),
            );
          }
          ...
          return ListView(
            children: selectedYearLogs.map<Widget>((document) {
              return _buildJanuaryRevenueListItems(document);
            }).toList(),
          );
        }
      },
  ...
  Widget _buildJanuaryRevenueListItems(DocumentSnapshot document) {
