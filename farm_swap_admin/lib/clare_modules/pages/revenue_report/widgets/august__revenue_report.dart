...
class AugustRevenueTabBarView extends StatefulWidget {
  const AugustRevenueTabBarView({super.key});

  @override
  State<AugustRevenueTabBarView> createState() =>
      _AugustRevenueTabBarViewState();
}

TextEditingController searchController = TextEditingController();
String searchValue = "";

class _AugustRevenueTabBarViewState extends State<AugustRevenueTabBarView> {
                        ...
                        Expanded(
                          ...
                          child: StreamBuilder<QuerySnapshot>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              // Displaying the sum of swapcoins for the month of august where status is COMPLETED
                              return Text(
    ...
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snapshot) {
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          // Filter logs for the selected year and august
          final selectedYearLogs = logs.where((document) {
            ...
            return (selectedYear == 'Overall' ||
                ...
                (dateTime as DateTime).month == DateTime.august;
          }).toList();

          // This will display if there are no logs for this month
          if (selectedYearLogs.isEmpty) {
            return const Center(
              child: Text('No revenue reports available for August!'),
            );
          }
