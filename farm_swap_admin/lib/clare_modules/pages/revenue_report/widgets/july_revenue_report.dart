...
class JulyRevenueTabBarView extends StatefulWidget {
  const JulyRevenueTabBarView({super.key});

  @override
  State<JulyRevenueTabBarView> createState() => _JulyRevenueTabBarViewState();
}

TextEditingController searchController = TextEditingController();
String searchValue = "";

class _JulyRevenueTabBarViewState extends State<JulyRevenueTabBarView> {
                        ...
                        Expanded(
                          ...
                          child: StreamBuilder<QuerySnapshot>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              // Filter documents for JULY
                              List<DocumentSnapshot> julyDocuments =
                              ...
                              double sum = julyDocuments.fold(0.0,
                              ...
                              // Displaying the sum of swapcoins for the month of july where status is COMPLETED
                              return Text(
    ...
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snapshot) {
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          // Filter logs for the selected year and July
          final selectedYearLogs = logs.where((document) {
            ...
            return (selectedYear == 'Overall' ||
                ...
                (dateTime as DateTime).month == DateTime.july;
          }).toList();

          // This will display if there are no logs for this month
          if (selectedYearLogs.isEmpty) {
            return const Center(
              child: Text('No revenue reports available for July!'),
            );
          }
