...
class SeptemberRevenueTabBarView extends StatefulWidget {
  const SeptemberRevenueTabBarView({super.key});

  @override
  State<SeptemberRevenueTabBarView> createState() =>
      _SeptemberRevenueTabBarViewState();
}

TextEditingController searchController = TextEditingController();
String searchValue = "";

class _SeptemberRevenueTabBarViewState
    extends State<SeptemberRevenueTabBarView> {
                    ...
                    child: Row(
                      children: [
                        const Expanded(
                          flex: 4,
                          child: Text(
                            'Revenue of the Month September',
                        ...
                        Expanded(
                          ...
                          child: StreamBuilder<QuerySnapshot>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              // Displaying the sum of swapcoins for the month of septmber where status is COMPLETED
                              return Text(
    ...
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snapshot) {
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          // Filter logs for the selected year and september
          final selectedYearLogs = logs.where((document) {
            ...
            return (selectedYear == 'Overall' ||
                ...
                (dateTime as DateTime).month == DateTime.september;
          }).toList();

          // This will display if there are no logs for this month
          if (selectedYearLogs.isEmpty) {
            return const Center(
              child: Text('No revenue reports available for September!'),
            );
          }
