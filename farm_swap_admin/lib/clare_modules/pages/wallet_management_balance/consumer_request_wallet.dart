                ...
                Row(
                  children: [
                    ...
                    Expanded(
                      ...
                      child: Row(
                        children: [
                          //sizedbox for reviewing request button of consumer wallet request
                          SizedBox(
                            child: Padding(
                                                                      ...
                                                                      showDialog(
                                                                          ...
                                                                          builder:
                                                                            ...
                                                                            return AlertDialog(
                                                                              ...
                                                                              content: const Text("Please input the right amount."),
                                                                              actions: <Widget>[
                                                                                TextButton(
                                                                                  child: const Text("Ok"),
                                                                                  onPressed: () async {
                                                                      ...
                                                                      showDialog(
                                                                          ...
                                                                          builder:
                                                                            ...
                                                                            return AlertDialog(
                                                                              ...
                                                                              content: Text("Successfully added balance to ${data["firstname"]} ${data["lastname"]}"),
                                                                              actions: <Widget>[
                                                                                TextButton(
                                                                                  child: const Text("Ok"),
                                                                                  onPressed: () async {
                                                                    ...
                                                                    showDialog(
                                                                      ...
                                                                      builder:
                                                                        ...
                                                                        return AlertDialog(
                                                                          ...
                                                                          content:
                                                                              Text("Are you sure you want to decline ${data["request"]}  request of ${data["firstname"]} ${data["lastname"]}?  \n Click Proceed to decline successfully."),
                                                                          actions: <Widget>[
                                                                            TextButton(
