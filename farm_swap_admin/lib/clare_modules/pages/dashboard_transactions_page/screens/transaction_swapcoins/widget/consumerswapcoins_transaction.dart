...
import 'package:farm_swap_admin/clare_modules/pages/dashboard_transactions_page/screens/transaction_swapcoins/widget/consumer_update_swapcoins.dart';
...
class ConsumerSwapcoinsTabBarView extends StatefulWidget {
  ConsumerSwapcoinsTabBarView({super.key, this.documentID});
  final String? documentID;
  String selectedId = "";

  @override
  State<ConsumerSwapcoinsTabBarView> createState() =>
      _ConsumerSwapcoinsTabBarViewState();
}

TextEditingController searchController = TextEditingController();
String searchValue = "";

class _ConsumerSwapcoinsTabBarViewState
    extends State<ConsumerSwapcoinsTabBarView> {
  @override
  ...
  Widget _buildSwapCoinsListItems(DocumentSnapshot document) {
    ...
    ConsumerUpdateSwapcoins updateSwapcoins = ConsumerUpdateSwapcoins();
                                  ...
                                  actions: <Widget>[
                                    TextButton(
                                      ...
                                      */
                                          ...
                                          await updateSwapcoins.updateSwapcoins(
                                  ...
                                  actions: <Widget>[
                                    TextButton(
                                      ...
                                      */
                                            ...
                                            await updateSwapcoins.updateDeduct(
                                                amountController.text,
                                                widget.selectedId);
                              ...
                              return AlertDialog(
                                ...
                                actions: <Widget>[
                                  TextButton(
                                    ...
                                    onPressed: () async {
                                      if (role == "CONSUMER") {
                                        ConsumerCheckSwapcoins checkSwapcoins =
                                            ConsumerCheckSwapcoins();
                                        final swapcoins = await checkSwapcoins
                                            .getSwapcoinsFromFirestore(
                                                widget.selectedId);
