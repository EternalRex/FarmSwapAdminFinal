...
class SpecificWalletDetailsConsumer extends StatefulWidget {
  const SpecificWalletDetailsConsumer({
    super.key,
    this.documentID,
  });
  ...
  @override
  State<SpecificWalletDetailsConsumer> createState() =>
      _SpecificWalletDetailsConsumerState();
}

class _SpecificWalletDetailsConsumerState
    extends State<SpecificWalletDetailsConsumer> {
  @override
              ...
              child: Scaffold(
                appBar: AppBar(
                  ...
                  title: const DashBoardTitleText(
                    myText: "Consumer Wallet History",
                                      ...
                                      child: FutureBuilder<DocumentSnapshot>(
                                          ...
                                          builder: (context, snapshot) {
                                            if (snapshot.connectionState ==
                                              ...
                                              return _buildSpecificConsumerWalletList(
                                                  specificUserId);
                                            } else {
                                              return Center(
                                                child: SizedBox(
  ...
  Widget _buildSpecificConsumerWalletList(String specificUserId) {
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snapshot) {
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          if (logs.isEmpty) {
            return const Center(
              child: Text('No consumer wallet history available!'),
            );
          }
          ...
          return ListView(
            children: logs.map<Widget>((document) {
              return _buildSpecificConsumerWalletListItems(document);
            }).toList(),
          );
        }
      },
  ...
  Widget _buildSpecificConsumerWalletListItems(DocumentSnapshot document) {
    ...
    //THIS IS FOR DISPLAYING THE PROOF PHOTO FOR THE WALLET CASH OUT
                    ...
                    if (statusType == "PENDING")
                      TextButton(
                        ...
                        onPressed: () {
                          ...
                          Navigator.of(context)
                              .pushNamed(RoutesManager.walletPage);
                        },
                      ),
                    TextButton(
