...
class ConsumerWalletTabBarView extends StatefulWidget {
  ConsumerWalletTabBarView({super.key, this.documentID});
  final String? documentID;
  String selectedId = "";

  @override
  State<ConsumerWalletTabBarView> createState() =>
      _ConsumerWalletTabBarViewState();
}

TextEditingController searchController = TextEditingController();
String searchValue = "";

class _ConsumerWalletTabBarViewState extends State<ConsumerWalletTabBarView> {
  @override
          ...
          children: [
            ...
            Container(
              ...
              child: SingleChildScrollView(
                child: SizedBox(
                  height: 500,
                  child: _buildConsumerWalletList(),
                ),
              ),
            ),
          ],
  ...
  //this is for the consumer collection build list
  Widget _buildConsumerWalletList() {
        ...
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          return ListView(
            children: logs.map<Widget>((document) {
              return _buildConsumerWalletListItems(document);
            }).toList(),
          );
        }
      },
  ...
  Widget _buildConsumerWalletListItems(DocumentSnapshot document) {
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Text(
                            "${data["baranggay"]}, ${data["city_municipality"]}",
                            style: const TextStyle(
                              fontSize: 10,
                            ),
                          ),
